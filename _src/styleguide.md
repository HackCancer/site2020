...
HackCancer is a planetary-scale blockchain database built on [BigchainDB](https://www.bigchaindb.com). It’s a ready-to-use public network with a focus on **strong governance**. It shares _all the features_ of BigchainDB to make developers’ lives easier.
...
<svg class="logo logo--lg" aria-labelledby="title"><title>Logo HackCancer</title><use xlink:href="/assets/img/sprite.svg#logo"></use></svg>
`logo--lg`: large version

<svg class="logo" aria-labelledby="title"><title>Logo HackCancer</title><use xlink:href="/assets/img/sprite.svg#logo"></use></svg>
`logo`: default logo

<svg class="logo logo--sm" aria-labelledby="title"><title>Logo HackCancer</title><use xlink:href="/assets/img/sprite.svg#logo"></use></svg>
`logo--sm`: small version

<svg class="logo logo--dark" aria-labelledby="title"><title>Logo HackCancer</title><use xlink:href="/assets/img/sprite.svg#logo"></use></svg>
`logo--dark`: dark version

<svg class="logo logo--white" aria-labelledby="title"><title>Logo HackCancer</title><use xlink:href="/assets/img/sprite.svg#logo"></use></svg>
...
<header class="section__header">
    ...
    <p class="section__description">HackCancer relies on caretakers to run the BigchainDB nodes that store and validate transactions. The HackCancer Caretakers are the members of the HackCancer Foundation.</p>
</header>
